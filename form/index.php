...
// test case
// http://localhost/home4/?username=Administrator&password=12345Dadada&confirm-password=12345Dadada&name=adadadada&surname=hdshdhdh&fathername=sggsdggsdsg&birthdate=1993-05-20&phone=9310070032&email=0112358bern%40mail.ru&event=sdfhsdhsdh&eventdate=2016-10-05&place=sdgsdghsjhsfdh&rate=3
	...
	if (isset ($_GET['login'])){
		...
		if(count($_GET) > 14){
			...
			$pl  = $_GET['place'];
			$rt  = (int)$_GET['rate'];
			$rv  = htmlspecialchars($_GET['rev'], ENT_HTML5);
